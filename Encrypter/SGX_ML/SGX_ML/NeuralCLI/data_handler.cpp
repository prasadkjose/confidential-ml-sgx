...
void data_handler::split_data()
{
  ...
  double train_size = data_array->size() * TRAIN_SET_PERCENT;
  double test_size = data_array->size() * TEST_SET_PERCENT;
  double valid_size = data_array->size() * VALID_SET_PERCENT;
